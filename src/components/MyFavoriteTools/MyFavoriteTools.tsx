        ...
        <div className="grid text-center">
          <Reveal>
            <div className="img-container">
              <img
                src="/assets/tools/typescript-icon.svg"
                alt="Typescript"
                width="50"
                height="50"
              />
              <img
                src="/assets/tools/HTML5_Badge.svg"
                alt="HTML5"
                width="50"
                height="50"
              />
              ...
              />
              <img
                src="/assets/tools/nodejs-icon-alt.svg"
                alt="Node.js"
                width="50"
                height="50"
              />
              <img
                src="/assets/tools/vitejs.svg"
                alt="Vite.js"
                width="50"
                height="50"
              />
